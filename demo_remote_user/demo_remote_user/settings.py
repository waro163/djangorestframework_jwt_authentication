"""
Django settings for demo_remote_user project.
...
SECRET_KEY = 'ff0)4%#h4ka8)-xh!bh-d(6w4xci8zi1v9#hdq(y9272tmw5$o'
...
ROOT_URLCONF = 'demo_remote_user.urls'
...
WSGI_APPLICATION = 'demo_remote_user.wsgi.application'
